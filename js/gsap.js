...
gsap.to("#sunbeam", { duration: 3, stroke: "yellow", opacity: .2, strokeWidth: 4, repeat: -1 })
...
gsap.fromTo("#bible", { fill: "red" }, { duration: 5, fill: "white" }, 10)
...
gsap.to("#radio", { fill: "pink" }, 12)
gsap.to("#noise", { stroke: "pink", repeat: -1 }, 14)
...
.fromTo("#num1", { y: 526 }, { duration: 1.2, y: 516, opacity: 1, ease: "bounce" }, 0)
    ...
    .fromTo("#rain", { opacity: 0 }, { duration: 1.5, opacity: 1, repeat: -1 }, 10)
